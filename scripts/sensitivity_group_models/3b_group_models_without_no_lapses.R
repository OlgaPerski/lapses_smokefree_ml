...
combined_roc_without_no_lapses <- bind_rows(rf_auc, elnet_auc, svm_auc, xgb_auc) %>%
...
write_rds(combined_roc_without_no_lapses, here("data", "group models", "combined_roc_without_no_lapses.rds"))

if(!file.exists(here("outputs", "group models", "plot_combined_roc_without_no_lapses.png"))) ggsave(combined_roc_without_no_lapses, filename = here("outputs", "group models", "plot_combined_roc_without_no_lapses.png"), 
