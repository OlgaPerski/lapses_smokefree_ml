...
mean(analytic_sample$cigs_per_day)
sd(analytic_sample$cigs_per_day)
...
sum(sample_20$craving_did_smoke == "true")/36974*100
sum(sample_20$craving_did_smoke == "false")/36974*100
...
sum(lapses$prop == 0)/790*100
sum(lapses$prop == 1)/790*100
sum(lapses$prop > 0.7)/790*100
sum(lapses$prop > 0.6)/790*100
sum(lapses$prop > 0.5)/790*100
...
if(!file.exists(here("outputs", "supp_fig_prop_lapses.png"))) ggsave(plot_prop_lapses, filename = here("outputs", "supp_fig_prop_lapses.png"), dpi = 320, height = 8, width = 10)
...
if(!file.exists(here("outputs", "supp_fig_days_since_qd.png"))) ggsave(plot_days, filename = here("outputs", "supp_fig_days_since_qd.png"), dpi = 320, height = 8, width = 10)
...
if(!file.exists(here("outputs", "supp_fig_median_mins_between_entries.png"))) ggsave(plot_mins, filename = here("outputs", "supp_fig_median_mins_between_entries.png"), dpi = 320, height = 8, width = 10)
...
if(!file.exists(here("outputs", "supp_fig_1_pred_vars.png"))) ggsave(plot_1, filename = here("outputs", "supp_fig_1_pred_vars.png"), dpi = 320, height = 14, width = 20)
if(!file.exists(here("outputs", "supp_fig_2_pred_vars.png"))) ggsave(plot_2, filename = here("outputs", "supp_fig_2_pred_vars.png"), dpi = 320, height = 14, width = 20)
if(!file.exists(here("outputs", "supp_fig_3_pred_vars.png"))) ggsave(plot_1, filename = here("outputs", "supp_fig_3_pred_vars.png"), dpi = 320, height = 14, width = 20)
...
if(!file.exists(here("outputs", "supp_fig_cpd_lapses.png"))) ggsave(cpd_lapses, filename = here("outputs", "supp_fig_cpd_lapses.png"), dpi = 320, height = 14, width = 20)
...
if(!file.exists(here("outputs", "supp_fig_craving_severity_lapses.png"))) ggsave(craving_severity_lapses, filename = here("outputs", "supp_fig_craving_severity_lapses.png"), dpi = 320, height = 14, width = 20)
...
if(!file.exists(here("outputs", "supp_fig_days_since_qd_lapses.png"))) ggsave(days_since_qd_lapses, filename = here("outputs", "supp_fig_days_since_qd_lapses.png"), dpi = 320, height = 14, width = 20)